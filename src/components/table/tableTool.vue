<template :inheritAttrs="false">
  <div class="df-cc" v-bind="$attrs">
    ...
    <el-tooltip v-if="refresh" effect="light" content="刷新" :offset="0" placement="bottom">
      <el-button class="fs20" type="text" v-color="'#bbb'" icon="el-icon-refresh-right" @click="handleRefresh"></el-button>
    </el-tooltip>
    <el-tooltip v-if="showExport" effect="light" content="导出" :offset="0" placement="bottom">
      <el-button class="fs20" type="text" v-color="'#bbb'" icon="el-icon-download" @click="handleExport"></el-button>
    </el-tooltip>
    <el-tooltip effect="light" content="间距" :offset="0" placement="bottom">
      <el-button class="fs20" type="text" v-color="'#bbb'" icon="yn-icon-colum-height" @click="handleSize"></el-button>
    </el-tooltip>
    <el-popover width="300px" :offset="0" placement="bottom" trigger="hover">
      <template #reference>
        <el-button class="fs20" v-color="'#bbb'" type="text" icon="el-icon-setting"></el-button>
      </template>
      ...
      <div class="tool-content px10 pt10">
        <el-checkbox-group class="df fw-w" v-model="state.checkedOpts" :min="1" @change="handleCheckedGroupChange">
  ...
  <el-dialog v-model="state.showExportSet" title="导出数据" width="400px">
    <el-form :model="state.form" label-width="84px">
      <el-form-item label="导出文件名">
        <el-input v-model="state.form.fileName"></el-input>
      </el-form-item>
      ...
      <el-form-item v-if="['xlsx', 'biff8'].indexOf(state.form.type) > -1" label="工作表名称">
        <el-input v-model="state.form.sheet"></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
